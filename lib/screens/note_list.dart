...
import 'package:memo_app3/db_helper/db_helper.dart';
import 'package:memo_app3/modal_class/notes.dart';
import 'package:memo_app3/screens/note_detail.dart';
import 'package:flutter_staggered_grid_view/flutter_staggered_grid_view.dart';
import 'package:memo_app3/screens/search_note.dart';
import 'package:memo_app3/utils/widgets.dart';
...
class NoteListState extends State<NoteList> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget myAppBar() {
      return AppBar(
        title:
            Text('Notes VSCode', style: Theme.of(context).textTheme.headline),
        centerTitle: true,
        elevation: 0,
